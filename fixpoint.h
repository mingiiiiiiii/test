...
int32_t fixpoint_mul_rnd13(const uint64_t x, const fp96_76* y, const uint8_t sign);
...
static inline void fixpoint_mul_high(fp96_76* xy, const fp96_76* x, const uint64_t y) {
	uint64_t tmp[2];
